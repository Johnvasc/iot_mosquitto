    ...
    if(option == "1"):
        ...
        if(option2=="1"):
            if(fountain==True): print('a fonte já estava ligada.\n')
                ...
                teste = client.publish('TigelaPet', 'set_On')
                fountain = True
            ...
            if(fountain==False): print('a fonte já estava desligada.\n')
                ...
                client.publish('TigelaPet', 'set_Off')
                fountain = False
        ...
        if(option3=="1"):
            if(fountain==True):
                if(presence==True): print('modo de deteccao já estava ativado!.\n')
                    ...
                    client.publish('TigelaPet', 'mode_pres')
            ...
            if(fountain==True):
                ...
                if(time<30):
                    ...
                    print('timer de '+timer+' segundos foi estabelecido!\n')
                    client.publish('TigelaPet', f'mode_time_{timer}')
            else: print('ative a fonte antes de selecionar essa opcao!\n')
